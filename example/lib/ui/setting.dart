...
class _SettingState extends State<Setting> {
  ...
  Widget build(BuildContext context) {
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              title: new Text("¡La configuración se ha guardado!",
                  style: TextStyle(
    ...
    var cardSettingData = [
      {
        'usernameField': 'Ingrese su nombre de usuario',
        'controllerName': userNameTextcontroller,
        'icon': Icons.person
      },
      {
        'usernameField': 'Ingrese el número de teléfono para recibir alertas',
